					...
					<div className="diploma" key={diploma.RA}>
						<div className="front">
							<div className="content">
								...
								<p className="paragraph">
									portador{diploma.gender === 'F' && 'a'} da cédula de identidade RG N° {diploma.rg} -
									SSP/SP,
								</p>
								<p className="paragraph">
									...
									{diploma.birth_date ? new Date(diploma.birth_date).getFullYear() : ''} e natural do
									Estado {this.getState(diploma.natural)} {diploma.natural || 'Bahia'},
								</p>
								...
								<p className="paragraph">
									...
									de {diploma.data_conclusao ? diploma.data_conclusao.split('/')[0] : ''} no curso de{' '}
									{diploma.curso}
								</p>
						...
						<div className="back">
							<div className="recognized -small">
								...
								<p className="paragraph">
									Credenciamento no Conselho Estadual de Educação de São Paulo - Portaria CEE-GP-120,
									de 22/03/2013, publicado no DOU de 23/03/2013, Seção 1, página 61
								</p>

								<p className="paragraph">
									Credenciamento no Ministério da Eduacação para oferta de Cursos EAD-Portaria N°945,
									de 18/09/2015, publicado no DOU de 21/09/2015, Seção 1, página 16
								</p>
							</div>
							...
							<div className="zone">
								<div className="area">
									...
									<div className="signatures">
										...
										<p className="signature">
											<span>Genivaldo Linhares Brandão</span> Gerente de Registros Acadêmicos e
